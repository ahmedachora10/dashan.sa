...
<head>
    <title>Scenic — Website Template by Colorlib</title>
    <meta charset="utf-8">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-8 text-center">
                        ...
                        <div class="mx-auto w-75">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto quibusdam possimus
                                quasi porro! Itaque?</p>
                        </div>
                        <p class="mt-5"><a href="contact.html" class="btn btn-outline-white btn-md ">Get in touch</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row mb-5 pt-0 site-section">
                    ...
                    <div class="col-md-5 ml-auto img-overlap">
                        <div class="img-1"><img src="images/sq_img_6.jpg" alt="Image"
                                class="img-fluid img-shadow"></div>
                        <div class="img-2"><img src="images/sq_img_10.jpg" alt="Image"
                                class="img-fluid img-shadow"></div>
                    </div>
                </div>
                <div class="row pb-0 border-top pt-5 block__19738 section-counter">
                    <div class="col-6 col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="d-flex align-items-center justify-content-center mb-2">
                            ...
                            <strong class="number" data-number="2393">2,393</strong>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
                        <a href="service-single.html" class="block__16443 text-center d-block">
                            ...
                            <p class="d-sm-block">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit
                                facilis, pariatur harum labore aperiam assumenda.</p>
                        </a>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="container">
                ...
                <div id="posts" class="row no-gutter" style="position: relative; height: 1584px;">
                    ...
                    <div class="item brand col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4"
                        style="position: absolute; left: 0px; top: 264px;">
                        <a href="portfolio-single.html" class="item-wrap">
                            <span class="icon-add"></span>
                    ...
                    <div class="item design col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4"
                        style="position: absolute; left: 270px; top: 264px;">
                        <a href="portfolio-single.html" class="item-wrap">
                            <span class="icon-add"></span>
                    ...
                    <div class="item web col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4"
                        style="position: absolute; left: 0px; top: 528px;">
                        <a href="portfolio-single.html" class="item-wrap">
                            <span class="icon-add"></span>
                    ...
                    <div class="item brand col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4"
                        style="position: absolute; left: 270px; top: 528px;">
                        <a href="portfolio-single.html" class="item-wrap">
                            <span class="icon-add"></span>
                    ...
                    <div class="item web col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4"
                        style="position: absolute; left: 0px; top: 792px;">
                        <a href="portfolio-single.html" class="item-wrap">
                            <span class="icon-add"></span>
                    ...
                    <div class="item design col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4"
                        style="position: absolute; left: 270px; top: 792px;">
                        <a href="portfolio-single.html" class="item-wrap">
                            <span class="icon-add"></span>
                    ...
                    <div class="item web col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4"
                        style="position: absolute; left: 0px; top: 1056px;">
                        <a href="portfolio-single.html" class="item-wrap">
                            <span class="icon-add"></span>
                    ...
                    <div class="item design col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4"
                        style="position: absolute; left: 270px; top: 1056px;">
                        <a href="portfolio-single.html" class="item-wrap">
                            <span class="icon-add"></span>
                    ...
                    <div class="item brand col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4"
                        style="position: absolute; left: 0px; top: 1320px;">
                        <a href="portfolio-single.html" class="item-wrap">
                            <span class="icon-add"></span>
                    ...
                    <div class="item design col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4"
                        style="position: absolute; left: 270px; top: 1320px;">
                        <a href="portfolio-single.html" class="item-wrap">
                            <span class="icon-add"></span>
