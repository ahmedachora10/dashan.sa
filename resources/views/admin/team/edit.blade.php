<x-app-layout>
    ...
    <x-theme.tab-list :route="route('team.update', $team)">
        <x-slot:arForm>
            ...
            <div class="col-md-6 col-12 mb-3">
                <x-dashboard.input-group type="text" name="linkedin" :value="$team->linkedin"  :title="trans('linkedin')" />
            </div>
            <div class="col-md-6 col-12 mb-3">
                <x-dashboard.input-group type="text" name="twitter" :value="$team->twitter" :title="trans('twitter')" />
            </div>
        </x-slot:arForm>
        <x-slot:enForm>
            <div class="col-md-6 col-12 mb-3">
