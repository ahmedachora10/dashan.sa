        ...
        <div class="section-head text-center">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-10">
                    <h6 class="custom-font wow fadeInDown custom-sub-title" data-wow-delay=".3s">{{ headLine('home-instagram-section')->title }}</h6>
                    <h2 class="playfont wow flipInX custom-sub-title" data-wow-delay=".5s">Instagram<span class="color-font">#</span></h2>
                </div>
            </div>
        </div>
    </div>
